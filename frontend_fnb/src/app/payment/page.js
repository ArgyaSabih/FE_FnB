...
export default function PaymentPage() {
  const {totalPrice, formatPrice} = useUser();

  return (
    <div className="container bg-fixed m-0 bg-gradient-to-b from-[#eeeeee] via-white via to-white h-screen">
      <div className="">
        <div className="container flex justify-center pt-6 mb-3">
      ...
      <Link href={"/completed"}>
        <button className="fixed justify-center w-11/12 p-4 px-4 text-sm font-semibold text-center text-white bg-black rounded-full bottom-3">
          Done
        </button>
      </Link>
